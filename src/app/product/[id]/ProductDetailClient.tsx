...
import { ShoppingCart, Loader2, ChevronRight, ShieldCheck, Sparkles, Truck, ChevronLeft } from "lucide-react";
        ...
        <div className="pt-24 lg:pt-28 pb-12">
            <div className="container mx-auto px-4">
                ...
                <div className="flex items-center gap-2 mb-3 md:mb-6 text-sm text-zinc-500">
                    <button
                        onClick={() => router.back()}
                        className="hover:text-black transition-colors flex items-center gap-1 p-1 -ml-1"
                        title="Go back"
                    >
                    ...
                    {product.categoryName && (
                        <>
                            ...
                            <Link
                                ...
                                className="text-black hover:font-medium transition-all truncate max-w-[120px]"
                            >
                                {product.categoryName}
                            </Link>
                        </>
                                    ...
                                    <div className={cn(
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 p-5 bg-zinc-50 border border-zinc-100 rounded-2xl">
                                            {featureList.map((feature, i) => {
                                                ...
                                                return (
                                                    <div key={i} className="flex items-center justify-between py-1.5 border-b border-zinc-200 last:border-0 md:last:border-b-1 border-dotted">
